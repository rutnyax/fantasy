...
<link rel="stylesheet" type="text/css" href='<spring:url value="/resources/css/dataTables.bootstrap.css" />'>
...
<script type="text/javascript" src='<spring:url value="/resources/js/dataTables.bootstrap.js" />'></script>
<!--[if lt IE 9]>
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href='<spring:url value="/home.html" />'>Fantasy</a>
				</div>
